        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/learn/repent" className="text-secondary-foreground/80 hover:text-secondary-foreground transition-colors">
                  How Do I Repent
                </Link>
              </li>
              <li>
                <Link to="/learn/12-tribes" className="text-secondary-foreground/80 hover:text-secondary-foreground transition-colors">
                  Who Are The Israelites Today?
                </Link>
              </li>
              <li>
                <Link to="/learn/holy-days" className="text-secondary-foreground/80 hover:text-secondary-foreground transition-colors">
                  Biblical Holy Days
                </Link>
              </li>
              <li>
                <Link to="/learn/pagan-holidays" className="text-secondary-foreground/80 hover:text-secondary-foreground transition-colors">
                  Pagan Holidays
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/ministries" className="text-secondary-foreground/80 hover:text-secondary-foreground transition-colors">
                  Our Ministries
                </Link>
              </li>
              <li>
                <Link to="/locations" className="text-secondary-foreground/80 hover:text-secondary-foreground transition-colors">
                  Locations
                </Link>
              </li>
              <li>
                <Link to="/calendar" className="text-secondary-foreground/80 hover:text-secondary-foreground transition-colors">
                  Holy Days Calendar
                </Link>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t border-secondary-foreground/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-6 text-sm">
              ...
              <Link to="/donate" className="text-secondary-foreground/60 hover:text-secondary-foreground transition-colors">
                Donate
              </Link>
              <Link to="/resources" className="text-secondary-foreground/60 hover:text-secondary-foreground transition-colors">
                Resources
              </Link>
              <Link to="/welcome-booklet" className="text-secondary-foreground/60 hover:text-secondary-foreground transition-colors">
                Welcome Booklet
              </Link>
            </div>
          </div>
