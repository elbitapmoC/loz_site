...
export function FontShowcase({ className }: FontShowcaseProps) {
  ...
  const fontCategories = {
    "Classic Serifs": ["cormorant", "eb-garamond", "cardo", "crimson"],
    "Modern Serifs": ["playfair", "lora", "spectral"],
    "Display Serifs": ["cinzel", "rozha", "gilda", "marcellus"],
  };
  
  return (
    <div className={cn("space-y-16", className)}>
      <h2 className="text-3xl font-bold text-center mb-8">Font Options for "Walk in Truth"</h2>
  ...
  primaryFont="outfit"      // outfit (default), tenor, fahkwang
  secondaryFont="cinzel"    // see options above
