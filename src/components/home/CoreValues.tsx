...
export function CoreValues({
            ...
            {values.slice(0, 4).map((value, index) => (
              <motion.div
                ...
                className={cn(
                  ...
                  "bg-primary/5 border-primary/10 hover:bg-primary/10 dark:border-primary/20"
                )}
              >
                <div className="mb-4 p-3 rounded-full inline-flex bg-primary/20 text-primary">
                  {value.icon}
                </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-12">
            {values.slice(0, 4).map((value, index) => (
              ...
              >
                <span
                  className={cn(
                    "text-xl font-serif font-medium inline-block relative text-foreground",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {values.slice(0, 4).map((value, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="p-5 rounded-lg border bg-card border-primary/20"
              >
                <div className="flex gap-4">
                  <div className="p-2 h-10 w-10 rounded-full flex items-center justify-center shrink-0 bg-primary/20 text-primary">
                    {value.icon}
                  </div>
                  <div>
                    ...
                    <blockquote className="pl-3 border-l-2 italic text-sm border-primary/40 text-foreground/80">
                      "{value.verseText}"{" "}
  ...
  return (
    <>
      <h2 className="text-foreground/80 text-3xl md:text-4xl mb-6 text-center">
