              ...
              <CardContent className="p-8 lg:p-12 space-y-8">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-muted/30 p-4 rounded-lg border-l-4 border-primary">
                      ...
                      <div className="space-y-2 text-sm leading-relaxed text-left">
                        <p><span class="font-semibold">Verse 7:</span> "Why doth one day excel another, when as all the light of every day in the year is of the sun?"</p>
                        <p><span class="font-semibold">Verse 8:</span> "By the knowledge of the Lord they were distinguished: and he altered seasons and feasts."</p>
                        <p><span class="font-semibold">Verse 9:</span> "Some of them hath He made high days, and hallowed them, and some of them hath He made ordinary days."</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-muted/30 p-4 rounded-lg border-l-4 border-primary">
                      ...
                      <div className="space-y-2 text-sm leading-relaxed text-left">
                        <p><span class="font-semibold">Verse 1:</span> "And the Lord spake unto Moses saying"</p>
                        <p><span class="font-semibold">Verse 2:</span> "Speak unto the children of Israel, and say unto them concerning the feasts of the Lord, which ye shall proclaim to be holy convocations, even <span class="text-primary font-semibold">these are my feasts</span>."</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="bg-red-50 dark:bg-red-950/20 p-4 rounded-lg border border-red-200 dark:border-red-800/50">
                    ...
                    <div className="space-y-2 text-sm leading-relaxed text-left">
                      <p><span class="font-semibold">Verse 4:</span> "Ye adulterers and adulteresses, know ye not that the friendship of the world is enmity with God? Whosoever therefore will be a friend of the world is the enemy of God."</p>
                      <p><span class="font-semibold">Verse 5:</span> "Do ye think that the scripture saith in vain, the spirit that dwelleth in us lusteth to envy?"</p>
                    </div>
                  </div>
