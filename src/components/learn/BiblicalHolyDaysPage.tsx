...
const holyDays: HolyDay[] = [
  ...
  },
  {
    ...
    category: "monthly",
    icon: Moon,
    synopsis: "The New Moon is the FULL Moon - not the dark phase. Made on 4th day of creation to rule the night and be for signs and seasons. All feasts are kept according to the new moon (except Sabbath). The eclipse at Christ's crucifixion proves this truth.",
    videoPlaceholder: "/videos/newmoon-explanation.mp4",
    timing: "First day of each Hebrew month - when moon is FULL (not dark)",
    scriptures: ["GEN 1:14-19", "LEV 23:1-4", "ECC 43:6-9", "1SAM 20:24-29", "ISA 66:23", "MAT 27:45", "NUM 28:11-15", "PSA 81:3"],
    keyPoints: ["New Moon = Full Moon (not dark)", "Made 4th day for signs/seasons", "Rules the night with light", "Feasts kept by new moon timing", "Family gatherings & dinners", "Eclipse proves full moon timing", "All flesh will worship new moon to new moon", "Bible reproves false astronomy", "Month called after moon's name"]
  },
  {
    id: "passover",
    name: "Passover",
