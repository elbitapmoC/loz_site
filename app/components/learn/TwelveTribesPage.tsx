...
const twelveTribes = [
  {
    ...
    description:
      "The firstborn of Jacob, known for his instability but also his compassion",
  ...
  },
  {
    ...
    slug: "/learn/dan",
    modernIdentity: "Native Americans",
  },
  {
    name: "Naphtali",
    hebrew: "נַפְתָּלִי",
    ...
    slug: "/learn/naphtali",
    modernIdentity: "Argentinians & Chileans",
  },
  {
    name: "Gad",
    hebrew: "גָּד",
  ...
  },
  {
    ...
    borderColor: "border-green-300/30",
    slug: "/learn/joseph",
    modernIdentity: "Europeans & Americans",
  },
  {
    name: "Benjamin",
    hebrew: "בִּנְיָמִין",
...
const historicalPeriods = [
  {
    ...
    description:
      "600,000 men plus women and children left Egypt under Moses' leadership",
    icon: Mountain,
  },
  {
    title: "The Divided Kingdom (922 BC)",
    description:
      "Ten tribes formed the Northern Kingdom, Judah and Benjamin the Southern",
    icon: Home,
  },
  {
    title: "Assyrian Conquest (722 BC)",
    description:
      "The ten northern tribes were scattered, becoming the 'Lost Tribes'",
    icon: Sword,
  },
  {
          ...
          <div className="text-center max-w-4xl mx-auto">
            <div>
              ...
              <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                The question &quot;Who are the Israelites today?&quot; is one of
                the most important questions for understanding biblical prophecy
                and God&#39;s covenant people. The Israelites are the
                descendants of the twelve sons of Jacob, whose name was changed
                to Israel.
              </p>
        ...
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
              Each tribe carries unique characteristics, blessings, and
              prophetic significance. Click on each tribe to learn more about
              their specific heritage and modern identity.
            </p>
            <p className="text-sm text-muted-foreground italic">
              *Note: Joseph received a double portion through his two sons
              Ephraim and Manasseh, making 13 tribes total, though traditionally
              counted as 12.
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {twelveTribes.map((tribe) => {
              // Map tribes to mothers and modern identities (based on 12 Tribes Chart context)
              const details = {
                Reuben: { mother: "Leah", identity: "Seminole Indians" },
                Simeon: { mother: "Leah", identity: "Dominicans" },
                Levi: { mother: "Leah", identity: "Haitians" },
                Judah: { mother: "Leah", identity: "Black Americans" },
                Dan: { mother: "Bilhah", identity: "Historical Judge" },
                Naphtali: { mother: "Bilhah", identity: "Argentina & Chile" },
                Gad: { mother: "Zilpah", identity: "Native Americans" },
                Asher: { mother: "Zilpah", identity: "Colombia to Uruguay" },
                Issachar: { mother: "Leah", identity: "Mexicans" },
                Zebulun: { mother: "Leah", identity: "Guatemala to Panama" },
                Joseph: {
                  mother: "Rachel",
                  identity: "Puerto Ricans & Cubans",
                },
                Benjamin: { mother: "Rachel", identity: "West Indians" },
              }[tribe.name] || {
                mother: "Israel",
                identity: "Covenant People",
              };
              ...
              return (
                <div key={tribe.name}>
                  <Link
                    href={tribe.slug}
                    className={tribe.slug === "#" ? "pointer-events-none" : ""}
                  >
                    <div className="tribe-card group">
                      {/* Mother Badge */}
                      <div className="absolute top-3 right-3 z-30 opacity-70 group-hover:opacity-100">
                        <Badge
                          variant="secondary"
                          className="bg-primary/5 hover:bg-primary/10 text-[10px] text-muted-foreground border-primary/10 font-serif tracking-wider"
                        >
                          Son of {details.mother}
                        </Badge>
                      </div>
                      <div className="tribe-card-border" />

                      <div className="tribe-card-content">
                        <div className="tribe-icon-wrapper">
                          <div className="tribe-icon-container">
                            <tribe.icon
                              className="h-8 w-8 text-primary/60"
                            />
                          </div>
                          <div className="tribe-icon-halo" />
                        </div>

                        <div className="tribe-info">
                          <h3 className="tribe-name">{tribe.name}</h3>
                          <div className="tribe-hebrew" lang="he" dir="rtl">
                            {tribe.hebrew}
                          </div>
                        </div>

                        <div className="tribe-identity-wrapper">
                        ...
                        <div className="tribe-footer">
                          <span className="tribe-action">
                            Explore Heritage
                            <ArrowRight className="tribe-arrow" />
                          </span>
                        </div>
                      </div>
                    </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                Jacob, later called Israel, was the second-born son of Isaac and
                Rebecca, the younger twin brother of Esau, and the grandson of
                Abraham and Sarah. According to biblical texts, he was chosen by
                God to be the patriarch of the Israelite nation.
              </p>
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-primary/30 pl-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Reuben — Seminole Indians; Simeon — Dominicans; Levi —
                    Haitians; Judah — African Americans; Issachar — Mexicans;
                ...
                <div className="border-l-4 border-primary/30 pl-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Joseph — Europeans & Americans; Benjamin — West Indians &
                    Jamaicans
                  </p>
                </div>
                <div className="border-l-4 border-primary/30 pl-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Dan — Native Americans; Naphtali — Argentinians & Chileans
                  </p>
                </div>
                <div className="border-l-4 border-primary/30 pl-4">
                  <h4 className="font-semibold mb-2">Sons of Zilpah</h4>
                  <p className="text-sm text-muted-foreground">
                    Gad — North American Indians; Asher — Colombians &
                    Brazilians
                  </p>
                </div>
              </div>
              ...
              <div className="aspect-square rounded-2xl bg-gradient-to-br from-primary/20 to-primary/5 p-8 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground text-sm mb-4">
                    The story begins when Jacob and his family went down to
                    Egypt as &quot;70 souls.&quot;
                  </p>
        ...
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              From Egypt to the Promised Land, through kingdom division to exile
              and scattering.
            </p>
          </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-sm">
                          The Assyrian conquest of Israel resulted in the mass
                          displacement of most of the Israelites, giving rise to
                          the legacy of the Ten Lost Tribes. The 10 tribes that
                          settled in northern Palestine were carried into
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-sm">
                          The Babylonian conquest of Judah resulted in the mass
                          displacement of much of the remaining Israelites, who
                          belonged to the Tribe of Judah and the Tribe of
                          Benjamin.
                        </p>
                      </div>
                    </div>
                ...
                <div className="space-y-4">
                  <div className="text-center">
                    ...
                    <div className="text-sm text-muted-foreground">
                      Lost Tribes scattered by Assyria
                    </div>
                  </div>
                  <Separator />
                  <div className="text-center">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-sm text-muted-foreground">
                      Tribes to be gathered in the end times
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-16">
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Understanding who the Israelites are today requires studying
              biblical prophecies, historical migrations, and the fulfillment of
              specific tribal blessings and curses.
            </p>
          </div>
              ...
              <Card className="h-full">
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    According to the Encyclopedia of Judaism, a wide range of
                    tribes and groups claim descent from the Israelites,
                    including sections of various African tribes and groups in
                    Afghanistan and Pakistan with sub-tribal names such as
                    Reubeni (Reuben), Efridar (Ephraim), and Ashuri (Asher).
                  </p>
                </CardContent>
              </Card>
            </div>
              ...
              <Card className="h-full">
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    The Israelites were scattered throughout the world as
                    prophesied in Scripture. Understanding requires studying
                    biblical prophecies about scattering, historical migrations,
                    cultural markers, and fulfillment of specific blessings and
                    curses.
                  </p>
                </CardContent>
              </Card>
      ...
      <section className="py-16">
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Essential biblical passages for understanding the tribes of Israel
        ...
        <div className="container text-center">
          <div>
            ...
            <p className="text-xl mb-8 max-w-4xl mx-auto opacity-90 leading-relaxed">
              This document serves as an introduction to understanding the
              identity of the Israelites today. Each tribe carries unique
              characteristics, prophecies, and modern-day connections that
              reveal God&#39;s eternal plan for His chosen people.
            </p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 max-w-2xl mx-auto mb-8">
              ...
              <cite className="text-sm opacity-70 mt-2 block">
                — Exodus 6:7
              </cite>
            </div>
